...
seed(); renderPalette(); updateLabels(); updateToolButtons(); updateShapeButtons(); updateUndoButton(); renderHome(); syncLibrary(); new ResizeObserver(() => { resizeGrid(); resizePreview(); }).observe(stage); resizeGrid(); resizePreview(); requestAnimationFrame(() => { resetView(); state.previewDirty = true; }); loop();
