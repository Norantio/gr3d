...
const state = {
  ...
  selection: null, gesturePreview: null, clipboard: null, redoHistory: [],
};
...
function updateSelectionActions() { const disabled = !state.selection; const empty = disabled || selectedKeys().length === 0; $('fillSelection').disabled = disabled; $('deleteSelection').disabled = empty; $('copySelection').disabled = empty; $('pasteSelection').disabled = !state.clipboard; }
